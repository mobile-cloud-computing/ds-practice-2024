...
from utils.pb.suggestions.suggestions_pb2 import SuggestionResponse, BookSuggestion
from utils.pb.suggestions.suggestions_pb2_grpc import SuggestionServiceServicer, add_SuggestionServiceServicer_to_server
...
class SuggestionService(SuggestionServiceServicer):
    ...
    def SuggestBooks(self, request, context):
        ...
        response.suggestions = random.choices(self.all_suggestions, k=3)
